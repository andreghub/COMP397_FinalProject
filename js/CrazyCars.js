(function(window) {
    ...
    p.changeState = function(state) {
        switch (state) {
            case game.GameStates.MAIN_MENU:
                ...
                break;
            case game.GameStates.OPTIONS_MENU:
                this.currentGameStateFunction = this.gameStateOptionsMenu;
                break;
            case game.GameStates.INSTRUCTIONS_MENU:
                this.currentGameStateFunction = this.gameStateInstructionsMenu;
                break;
    ...
    p.gameStateMainMenu = function(tickEvent) {
        ...
        scene.on(game.GameStateEvents.INSTRUCTIONS_MENU, this.onStateEvent, this, true, { state: game.GameStates.INSTRUCTIONS_MENU });
        scene.on(game.GameStateEvents.OPTIONS_MENU, this.onStateEvent, this, true, { state: game.GameStates.OPTIONS_MENU });
        stage.addChild(scene);
        this.disposeCurrentScene();
        this.currentScene = scene;
        this.changeState(game.GameStates.RUN_SCENE);
    }
    p.gameStateOptionsMenu = function(tickEvent) {
        var scene = new game.OptionsMenu();
    ...
    p.gameStateInstructionsMenu = function(tickEvent) {
        var scene = new game.InstructionsMenu();
        scene.on(game.GameStateEvents.MAIN_MENU, this.onStateEvent, this, true, { state: game.GameStates.MAIN_MENU });
        stage.addChild(scene);
        this.disposeCurrentScene();
        this.currentScene = scene;
    ...
    window.game.CrazyCars = CrazyCars;
